...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-red-950 via-gray-900 to-black text-white h-20 px-4 md:px-9 text-center flex flex-row items-center justify-between"> {/* Dark red to black gradient */}
