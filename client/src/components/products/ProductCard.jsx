    ...
    >
      <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
        ...
        <div className="px-3 md:px-6 pt-3 md:pt-6 pb-1 md:pb-4">
          <h1 className="title-font text-base md:text-lg font-medium text-white mb-1">
            {data.name}
          </h1>
          <h2 className="text-xs mb-1 md:mb-2 font-medium text-white">
            BRAND: {data.brand}
          </h2>
          <p className="mb-1 text-sm md:text-base text-red-500 font-semibold">
            Rs.{data.pricePerUnit}/{data.measuringUnit}
          </p>
          <h2 className="text-xs title-font font-medium text-white mb-2">
