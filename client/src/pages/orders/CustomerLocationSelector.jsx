...
const CustomerLocationSelector = ({
  ...
  return (
    <div className="bg-gray-900  w-full xl:w-[500px] flex justify-between items-center md:items-start px-4 py-6 md:p-6 xl:p-8 flex-col">
      <div className="flex flex-col md:flex-row xl:flex-col justify-start items-stretch h-full w-full md:space-x-6 lg:space-x-8 xl:space-x-0">
        ...
        <div className="flex justify-between xl:h-full items-stretch w-full flex-col mt-6 md:mt-0">
          ...
          <div className="flex w-full my-2 justify-center items-center md:justify-start md:items-start">
            <button
              className="mt-6 md:mt-0 text-white  py-5 hover:bg-gray-200 hover:text-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 border border-white font-medium w-96 2xl:w-full text-base leading-4 text-gray-800"
              onClick={() => {
